...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    //Notification title
    $title = utf8_encode("Alert!");

    //AppU unique id variable is reponsible to detecting the intruder activity
    $appUniqueID = $_POST['appUniqueID'];

    //Notification message body
    $content_text = utf8_encode($appUniqueID);
